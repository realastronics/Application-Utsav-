...
import com.example.utsav.models.ChatMessage;

public class ManagerNotification extends AppCompatActivity {
    ...
    private void selectTab(TextView selected) {
        int grey   = getColor(R.color.purple_primary);
        int purple = getColor(R.color.nav_active);
    ...
    private void setupCardListeners() {
        ...
        cardMessage1.setOnClickListener(v -> {
            startActivity(new Intent(this, ChatMessage.class));
        });
        cardSubscription.setOnClickListener(v -> {
            startActivity(new Intent(this, Promotion_Visibility.class));
        });
